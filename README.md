...
[![Version](https://img.shields.io/badge/version-v5.3-0f766e)](CHANGELOG.md)
...
- **macOS**：本地构建产物为 `release/清账-macOS-v5.3.dmg`，打开后把 `清账.app` 拖到“应用程序”即可。
- **Windows**：仓库提供 GitHub Actions 打包流程，会生成 `QingZhang-v5.3-Setup.exe` 安装器，安装后会创建开始菜单和桌面快捷方式。

## 账单管理系统 v5.3 - 专业工作台界面版
