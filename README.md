...
[![Version](https://img.shields.io/badge/version-v5.2-0f766e)](CHANGELOG.md)
[![License](https://img.shields.io/badge/license-personal--use-lightgrey)](LICENSE.txt)

清新高级的本地账单管理系统。支持多账本、多人模式、主账单关联、转账平账、预算统计、加密存储、Excel 导出和 PNG 图表导出。
...
- **清爽桌面 UI**：浅色高级主题、预算卡片、清晰表格和稳定的首次运行窗口。
