...
[![Version](https://img.shields.io/badge/version-v5.6-0f766e)](CHANGELOG.md)
...
- **macOS**：本地构建产物为 `release/QingZhang-macOS-v5.6.dmg`，打开后把 `清账.app` 拖到“应用程序”即可。
- **Windows**：仓库提供 GitHub Actions 打包流程，会生成 `QingZhang-v5.6-Setup.exe` 安装器，安装后会创建开始菜单和桌面快捷方式。
...
### v5.6 专业精简版 (2026-05-03)
- **界面文案精简**：删除页面副标题、卡片说明、长提示和辅助解释
- **首次配置简化**：路径配置窗口只保留必要字段、状态和操作
- **反馈更克制**：移除状态栏和弹窗中的装饰性表情，保留必要确认与错误反馈
